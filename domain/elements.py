...
def soil(data):
    return {"K": data["S_K"], "MG": data["S_MG"], "CA": data["S_CA"], "NA": data["S_NA"],
...
def leaf(data):
    ...
    return {"N": data["L_N"], "NO3N": data["L_NO3N"], "S": data["L_S"], "P": data["L_P"],
...
def fruit(data):
    # TODO VALIDATE THIS ELEMENTS
    return {"N": data["F_N"], "NO3N": data["F_NO3N"], "S": data["F_S"], "P": data["F_P"],
